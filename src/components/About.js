...
export default function About({ title, handleCtaClick }) {
    ...
    <div className="card justify-stretch bg-base-200 mx-auto w-96 shadow-xl">
      ...
      <div className="card-body justify-stretch items-center text-center">
        <div className='text-yellow-200 text-l font-mono'><h1 className='font-semibold text-xl text-stretch text-yellow-600'>::COFFEE, TEA, & READ::</h1> is an app for coffee, tea and book 
          ...
          organic fair trade coffee beans from Mexico, to chocolate covered Espresso beans, books about coffee and tea, and more! </div>
      </div>
    </div>
  );
}
